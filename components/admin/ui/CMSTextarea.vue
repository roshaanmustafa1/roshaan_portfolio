  ...
  <div class="space-y-1.5 w-full">
    ...
    <div class="relative">
      <textarea
        ...
        :rows="rows || 4"
        class="w-full bg-[#080810] border border-white/10 rounded-lg px-4 py-3 text-sm text-gray-100 
               placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-violet-500/50 
               focus:border-violet-500/50 transition-all duration-200 resize-y min-h-[100px]"
      />
    </div>
